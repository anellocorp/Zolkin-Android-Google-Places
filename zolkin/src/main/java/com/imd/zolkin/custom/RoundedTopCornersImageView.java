...
public class RoundedTopCornersImageView extends ImageView
{
	...
	public RoundedTopCornersImageView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		clipPath = new Path();
		rect = new RectF(0, 0, this.getWidth(), this.getHeight() + radius * 2);
	}
	
	public RoundedTopCornersImageView(Context context, AttributeSet attrs, int defStyle)
	{
